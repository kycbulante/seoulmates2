                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php
                                    $order_query = "SELECT o.id as oid, o.tracking_id, o.user_id, oi.*, oi.qty as orderqty, p.* FROM orders o, order_items oi, products p
                                    WHERE oi.order_id=o.id AND p.id = oi.prod_id AND o.tracking_id='$tracking_no'";
                                    ...
                                    if(mysqli_num_rows($order_query_run)>0)
                                    {
                                        foreach($order_query_run as $item)
                                        {
                                            ?>
                                            <tr>
                                            <td class="align-middle"><img src="../uploads/<?= $item['image']; ?>" width = "50px"  height = "50px" alt="<?=$item['product_title']; ?>"></td>
                                ...
                                <hr>
                                <h5>Total Price: <span class="float-end fw-bold"><?=$data['total_price']; ?></span> </h4>
                                <hr>
                                ...
                                <div class="mb-3">
                                    <form action="code.php" method="POST">
                                        <input type="hidden" name="tracking_no" value="<?=  $data['tracking_id'] ?>">
